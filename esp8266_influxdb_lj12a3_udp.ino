...
void setup(void) {
  ...
  String hostname = "SENSOR-LJ12A3-" + String(ESP.getChipId());
  WiFi.hostname("SENSOR-LJ12A3-" + String(ESP.getChipId()));
  
  String ssid = "SENSOR-LJ12A3-" + String(ESP.getChipId());
...
void sendData( time_t time ) {
  ...
  pulseCount = 0;
  String line;
  line = String("flow,device=" + String(SENSOR_LOCATION) + " value=" + String((float)l_flow));
  Serial.println(line);
